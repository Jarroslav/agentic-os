...
bash tests/run-matrix.sh             # T1–T8 acceptance (35 checks; re-runs the output-contract suite as T7)
```

**What CI proves, deterministically, on every PR:** 85 checks — 50 hook unit
tests (`tests/t0/run.sh`) plus the 35-check T1–T8 acceptance matrix — and JSON
