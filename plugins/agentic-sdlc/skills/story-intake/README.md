...
You don't call this skill by hand. `sdlc-engine` runs it automatically at Phase 1, and it receives whatever argument you gave an entry skill:

- `sdlc-guided` — human-in-the-loop run.
- `sdlc-auto` — autonomous run.
