...
Read `qa-strategy.md → Integration / E2E Tests`.
...
Read `qa-strategy.md → Integration / E2E Tests` for coverage areas (e.g. `e2e/`, `integration/`, or named feature subdirectories):
