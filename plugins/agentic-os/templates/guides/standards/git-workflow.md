...
- The SessionStart hook fetches and integrates the integration branch automatically at session start.
...
(`.githooks/pre-commit`, installed via `bash scripts/install-git-hooks.sh`) blocks any
